    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                ...
                <a href="https://github.com/emm-henkel/react-portfolio" target="_blank" rel="noreferrer"><h2>Original Portfolio</h2></a>
                <p>The original version of my portfolio, but my first attempt at marketing myself that helped me land my first internship which evolved into a full time offer.</p>
            </div>
            {/* <div className="project">
